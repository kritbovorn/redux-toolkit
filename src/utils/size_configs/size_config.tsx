...
class SizeConfig {
    ...
    static readonly head5 = this.screenHeight * 0.04355;    // 26
    static readonly head4 = this.screenHeight * 0.0402; // 24
    static readonly head3 = this.screenHeight * 0.0368; // 22
    static readonly head2 = this.screenHeight * 0.0335; // 20
    static readonly head1 = this.screenHeight * 0.03;   // 18
    static readonly head = this.screenHeight * 0.0268;  // 16
